...
$installer->addCategoryAttribute(
    ...
    array(
        ...
        "backend"  => "",
        "frontend" => "",
        "label"    => "Mega-Menu CMS Block",
        "input"    => "select",
        "frontend_class"    => "megamenu-cms-block",
        "source"   => "creatuity_megamenu/catalog_category_attribute_megamenu_source_cmsBlock",
...
$installer->addCategoryAttribute(
    "megamenu_optlevel_onajaxcalls", 
    array(
        "type"     => "varchar",
        "backend"  => "",
        "frontend" => "",
        "label"    => "Mega-Menu Optimization Level (On Ajax Calls)",
        "input"    => "select",
        "frontend_class"    => "megamenu-optimization",
        "source"   => "creatuity_megamenu/catalog_category_attribute_megamenu_source_optimization",
        "global"   => Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_STORE,
